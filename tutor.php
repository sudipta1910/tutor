    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="images/logome.png" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="candinfo.php">candidate</a></li>
						
						<!--<li><a class="nav-link" href="tutorpost.php">Notice</a></li>-->
                        <li><a class="nav-link" href="logout.php">logout</a></li>
                        <li><a class="nav-link" href="passchangetut.php">Change Password</a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-md-6">
                    <div class="full">
                       <div>
                            <form action="tutor.php?id=<?php echo $id;?>" method="post">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Info</h5>
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                    <td scope="col" >ID :<?php echo $row['id']; ?></td>
                                                    </tr>
                                                        <tr>
                                                            <td scope="col">Name :<?php echo $row['name']; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="col">Email :<?php echo $row['email']; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="col">phone :<?php echo $row['phone']; ?></td>
                                                        </tr>
                                                </tbody>
                                            </table>
                                        
                                        <a href="edittut.php" class="btn btn-primary">Update</a>
                                    </div>
                                </div>
                            </form>
                        </div>
