            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="tutinfo.php">Tutor</a></li>
						<!--<li><a class="nav-link" href="choose.php">Choose Tutor</a></li>-->
						<!--<li><a class="nav-link" href="viewcan.php">Notice</a></li>-->
                        <li><a class="nav-link" href="logout.php">logout</a></li>
                        <li><a class="nav-link" href="passchangecand.php">Change Password</a></li>
                    </ul>
                </div>
                    ...
                    <div class="card" style="width: 30rem;">
                        <img src="<?php echo $img ?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                ...
                                <a href="editcand.php" class="btn btn-primary">Update</a>
                            </div>
                        </div>
                    </div>
                    </div>
